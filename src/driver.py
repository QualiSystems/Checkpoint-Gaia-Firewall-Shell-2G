...
class CheckpointShellDriver(ResourceDriverInterface, FirewallResourceDriverInterface):
    ...
    def health_check(self, context: ResourceCommandContext) -> str:
        ...
        with LoggingSessionContext(context) as logger:
            ...
            resource_config = FirewallResourceConfig.from_context(context, api)
            cli_configurator = CheckpointCliConfigurator.from_config(
    ...
    def get_inventory(self, context: AutoLoadCommandContext) -> AutoLoadDetails:
        ...
        with LoggingSessionContext(context) as logger:
            ...
            enable_disable_snmp_flow = CheckpointEnableDisableSnmpFlow(cli_configurator)
            ...
            autoload_operations = CheckpointSnmpAutoloadFlow(snmp_configurator)
    ...
    def save(
        ...
        with LoggingSessionContext(context) as logger:
            ...
            configuration_operations = CheckpointConfigurationFlow(
