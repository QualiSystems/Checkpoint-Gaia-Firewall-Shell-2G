...
### **Checkpoint Gaia Firewall Shell 2G**
**Checkpoint Gaia Firewall Shell 2G** provides you with connectivity and management capabilities such as device structure discovery and power management for the resource. 

For more information on the device, see the vendor's official product documentation.

### Standard version
**Checkpoint Gaia Firewall Shell 2G** is based on the Firewall Shell Standard version **3.0.1**.
...
#### **Checkpoint Gaia Firewall Shell 2G Attributes**
...
|:---|:---|
|CheckpointGaiaFirewallShell2G.zip|Device shell package|
|Checkpoint_Gaia_Firewall_Shell_2G_offline_dependencies.zip|Shell Python dependencies (for offline deployments only)|

# Importing and Configuring the Shell
This section describes how to import the **Checkpoint Gaia Firewall Shell 2G** shell and configure and modify the shell’s devices.
...
1. Download the *Checkpoint_Gaia_Firewall_Shell_2G_offline_dependencies.zip* file, see [Downloading the Shell](#downloading-the-shell).
...
**To create a resource for the device:**
  ...
  2. From the list, select **Checkpoint Gaia Firewall Shell 2G**.
...
For release updates, see the shell's [GitHub releases page](https://github.com/QualiSystems/CheckpointGaiaFirewallShell2G/releases).
